...
De 100 em 100 anos não é ano bissexto; De 400 em 400 anos é ano bissexto; 
...
function anoBissexto($ano){
    if(($ano % 400 == 0) || ($ano % 4 == 0 && $ano % 100 != 0)){
        return "O ano é bissexto " . $ano;
    }else{
        return "O ano não é bissexto " . $ano;
    }
}

echo anoBissexto(1567);
